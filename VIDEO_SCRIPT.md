# Technical Walkthrough Script: Master the Agency OS

---

## 1. Introduction (0:00 - 1:00)
"Welcome to the technical walkthrough of Agency Nexus. In the next 10 minutes, I’m going to show you how to transform a standard WordPress site into a professional Agency HQ. We’ll cover everything from lead intelligence and interactive scoping to client portals and real-time profitability tracking."

---

## 2. Global Calibration (1:00 - 2:30)
"Every high-performance agency starts with standard settings. Navigate to **Nexus > Settings**.
1. **Branding:** Upload your high-res logo. This instantly replaces our branding on your client's end.
2. **Finance:** Set your **Blended Hourly Rate**. This is the secret sauce for our ROI calculator later on.
3. **Email:** Configure your **SMTP Settings**. We want to ensure that every automated invoice and daily briefing is delivered flawlessly.
4. **Seeding:** If you're new, click 'Add Best Sample Content' at the bottom to see the system in full action."

---

## 3. The Sales Engine: Lead to Scoping (2:30 - 4:30)
"Now, let’s get some business. Go to **Leads**. Use the 'Generate Embed Code' tool to drop a high-converting form on your landing page.
Once a lead arrives, look at the **Lead Score**. High-value leads are flagged automatically.
Ready to close? Open the **Scope Builder**. Select your service package, pick a scale, and add addons like 'Express Delivery.' The system builds the roadmap and budget instantly. Send the **Proposal link**—your client can review and e-sign it in seconds."

---

## 4. Operational Fulfillment (4:30 - 6:30)
"Once the deal is signed, it becomes an active **Project**. Inside the project view, we manage the 'Execution Flow.'
...
When a draft is ready, the client gets a notification to visit their portal.
...
Because your team logged their hours and you set your hourly rate, Agency Nexus shows you your **True Project Profitability** in real-time. If a project is eating up too many resources, you'll see the margin drop into the red.
...
---
*Technical Note: Ensure 'Demo Mode' is active during the recording to showcase a populated dashboard.*
